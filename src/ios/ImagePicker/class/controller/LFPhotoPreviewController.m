...
@interface LFPhotoPreviewController () <UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate,LFPhotoPreviewCellDelegate, CustomPhotoEditingControllerDelegate, LFVideoEditingControllerDelegate>
{
    UIView *_naviBar;
    UIView *_naviSubBar;
...
//    }
    if (@available(iOS 11.0, *)) {
        naviBarHeight = kCustomTopbarHeight_iOS11;
    } else {
        naviBarHeight = kCustomTopbarHeight;
    }
...
- (void)configPreviewBar {
    ...
    __weak LFPhotoPreviewController *weakSelf = self;
