...
#pragma clang diagnostic pop
        ...
        __weak LFPhotoPickerController *weakSelf = self;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setSelectButtonHidden:(imagePickerVc.maxImagesCount==1 && imagePickerVc.cutType<=1)];
    
    __weak LFPhotoPickerController *weakSelf = self;
    __weak LFImagePickerController *weakImagePickerVc = imagePickerVc;
