...
- (UIImage *)LFME_captureImageAtFrame:(CGRect)rect cutType:(NSInteger)cutType cornerRadius:(float)cornerRadius
{
    UIImage* image = nil;
...
//    CGRect rect1 = CGRectMake(inset, inset, image.size.width - inset * 2.0f, image.size.height - inset * 2.0f);
