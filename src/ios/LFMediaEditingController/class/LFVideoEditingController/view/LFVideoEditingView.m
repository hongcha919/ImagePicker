...
/** 重置剪裁 */
- (void)resetClipping:(BOOL)animated
{
    [self.clippingView cancel];
    [self setIsClipping:YES animated:animated];
}
...
/** 获取裁剪后的视频时长 */
-(double)getEditVideoDuration {
    return self.clippingView.endTime-self.clippingView.startTime;
}
