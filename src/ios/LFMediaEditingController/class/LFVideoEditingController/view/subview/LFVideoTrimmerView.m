...
#define LFVideoTrimmerView_timeLabel_height 20.f
...
- (void)customInit
{
    ...
    UILabel *showTimeLabel = [self timeLabel];
    timeLabelRect.origin.x = (CGRectGetWidth(self.frame)-2*timeLabelRect.size.width)/2;
    timeLabelRect.origin.y = CGRectGetHeight(self.frame)-timeLabelRect.size.height-15;
    showTimeLabel.frame = CGRectMake(60, -15, CGRectGetWidth(self.frame)-120, LFVideoTrimmerView_timeLabel_height+15);
    showTimeLabel.textAlignment = NSTextAlignmentCenter;
    showTimeLabel.font = [UIFont systemFontOfSize:18];
    showTimeLabel.text = @"裁剪后时长:0秒";
